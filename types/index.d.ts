...
import { RaycastIterator } from 'prismarine-world' // TODO: types for prismarine-world
import { RecipeClasses } from 'prismarine-recipe'

type Recipe = RecipeClasses['Recipe'] // TODO: EXPORT THIS PROPERLY FROM PRISMARINE-RECIPE

export function createBot(options: { client: Client } & Partial<BotOptions> | BotOptions): Bot
...
export interface Bot extends TypedEmitter<BotEvents> {
    ...
    blockAtCursor: (maxDistance?: number, matcher?: (block: Block, iter: RaycastIterator) => boolean) => Block | null
    blockAtEntityCursor: (entity?: Entity, maxDistance?: number, matcher?: (block: Block, iter: RaycastIterator) => boolean) => Block | null
